  ...
  dashboardBody(
    tabItems(
      tabItem(tabName = "Input",
              radioButtons("Data_2_use","Data to use",choices = c("mzXML file"="Your_own_data","Demonstration file"="Demo_file","Saved file"="Saved_file"),selected = "Your_own_data"),
              uiOutput("Data_2_use"),
              br(),
              column(6,
      ...
      tabItem(tabName = "Preparation",
              ...
              column(4,h4("Clusterisation"),
                      numericInput("tsne_initial_dims","Initial dimention",30),
                      ...
                      numericInput("tsne_max_iter","Maximum interation",300),
                     ...
                     uiOutput("Clusterisation_feedback_1")
              ),
              column(12,
      ...
      tabItem("Visualization",
              column(12,
                     ...
                     div(style="display: inline-block;vertical-align:top; width: 150px;",selectizeInput("VarSel_eic_pch","Label in the 2D map",choices = c("m/z","punct","circles"),selected="m/z")),
                     ...
                     div(style="display: inline-block;vertical-align:top; width: 120px;",selectizeInput('format', 'Document format', c('PDF'="PDF", 'HTML'="HTML","MS Word" = 'Word'))),
